...
Answer in 2-3 concise sentences. Be specific to their data, not generic."""
    ...
    try:
        response = ollama.chat(
            ...
            messages=[
                    {"role": "system", "content": "You are a data analyst assistant. Respond directly without showing your thinking process."},
...
def narrate_insights(run_id: str):
    ...
    try:
        response = ollama.chat(
            ...
            messages=[
                {"role": "system", "content": "You are a data analyst. Respond directly without showing your thinking process."},
